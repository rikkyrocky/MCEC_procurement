...
class Ubot:
    ...
    def process(self):
        ...
        for invoice in Invoices:
            ...
            invoice_info['invoice_number'] = "823514" #input("Invoice number?:")
            invoice_info['PO'] = "10359531" #input("PO #?:")
            invoice_info['date'] = "130223" #input("date? (ddmmyy):")
            invoice_info['gst'] = "0" #input("gst amount?:")
            invoice_info['amount'] = "145.71" #input("Invoice amount?:")
            invoice_info['#lineitems'] = "3" #str(input("# of line items?"))
        ...
        try:
            ...
            sleep(0.15)
            click_coords("/html/body/div[2]/ux-dialog-container[3]/div/div/div/div[2]/div/div/section/form/div/div/div[2]/div[2]/div/div/div[1]/div[1]/div/div/div/div[2]/a[2]", 0, 90)
        except Exception as e:
        ...
        try:
            ...
            openPOlineitems = self.driver.find_elements_by_xpath("//input[@type='checkbox']")

            print(openPOlineitems)
            print(f"there are {str(openPOlineitems)} open PO line items")
        except Exception as e:
            print(f"error: {e}")
